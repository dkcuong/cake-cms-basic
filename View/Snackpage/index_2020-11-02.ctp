<div class="div-snackpage">
    <div class="div-top">
        <div class="div-breadcrumb">
            <div class="title big">Snack</div>
        </div>
        <div class="div-button-header">
            <button class="btn-set-member title small narrow light-brown">MEMBER CODE</button>
            <button class="btn-clear-all title small narrow light-red">CLEAR ALL</button>
        </div>
    </div>
                                    ...
                                    <a data-id="<?= $item['Item']['id'] ?>" data-code="<?= $item['Item']['code'] ?>" data-price="<?= $item['Item']['price'] ?>">
                                        <div class="div-item-box">
                                            ...
                                            <div class="div-item-info">
                                                <div class="div-item-code content smallest"><?= $item['ItemLanguage']['name'] ?></div>
                                                <?php
                                                    if (trim($item['Item']['material']) != '') {
                                                ?>
                                                        <div class="div-item-material content light super-small">- <?= $item['Item']['material'] ?></div>
                                                <?php
                                                    }
                                                ?>
                                            </div>
