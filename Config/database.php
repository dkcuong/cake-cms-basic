...
class DATABASE_CONFIG {
	...
	function __construct (){
		$this->default = array(
			...
			'port' => Environment::read('database.port'),
			'login' => Environment::read('database.login'),
			'password' => Environment::read('database.password'),
			'database' => Environment::read('database.db'),
			'prefix' => Environment::read('database.prefix'),
			'encoding' => Environment::read('database.encoding'),
			'unix_socket' => Environment::read('database.unix_socket')
		);
	}
}