...
<div class="row filter-panel">
    <div class="col-md-12">
        <?php 
            echo $this->Form->create('Movie.movie_filter', array(
                'url' => array('controller' => 'movies', 'action' => 'index', 'admin' => true, 'prefix' => 'admin'),
                'class' => 'form_filter',
                'type' => 'get',
            ));
        ?>
        <div class="action-buttons-wrapper border-bottom">
            <div class="row">
                ...
                <div class="col-md-4">
                    <?php 
                        echo $this->Form->input('movie_type', array(
                            'class' => 'form-control',
                            'empty' => __("please_select"),
                            'options' => $movie_types,
                            'selected' =>  isset($data_search['movie_type']) ? $data_search['movie_type'] : '',
                    ...
                    <div class="pull-right vtl-buttons">
                        ...
                        <?php
                            echo $this->Html->link(__('reset'), array(
                                'plugin' => 'movie', 'controller' => 'movies', 'action' => 'index',
