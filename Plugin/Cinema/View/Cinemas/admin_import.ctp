	...
	<div class="col-xs-12">
		<div class="box box-primary">
			<div class="box-header">
				<h3 class="box-title"><?php echo __d('cinemas', 'import_cinema'); ?></h3>
			</div>

			<div class="box-body">
				<?php echo $this->Form->create('Cinema', array('role' => 'form','type' => 'file')); ?>
					<fieldset>

						<div class="form-group">
							<input type="file" name="data[Cinema][file]" accept=".xlsx">
						</div>
