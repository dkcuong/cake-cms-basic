...
<?= $this->element('Cinema.hall_filter', array(
		...
		<div class="box box-primary">
			<div class="box-header">
                ...
                <?php if(isset($permissions[$model]['add']) && ($permissions[$model]['add'] == true)){ ?>
                    <?= $this->Html->link( '<i class="glyphicon glyphicon-plus"></i> ' . __d('place', 'add_hall'), array('action' => 'add'), array('class' => 'btn btn-primary', 'escape' => false)); ?>
                <?php } ?>
				</div>
			</div>	

			<div class="box-body table-responsive">
				<table id="Halls" class="table table-bordered table-striped">
					<thead>
						<tr>
							<th class="text-center"><?= $this->Paginator->sort('id', __('id')); ?></th>
							<th class="text-center"><?= $this->Paginator->sort('code', __('code')); ?></th>
							<th class="text-center"><?= $this->Paginator->sort('max_seat', __d('place', 'max_seat')); ?></th>
