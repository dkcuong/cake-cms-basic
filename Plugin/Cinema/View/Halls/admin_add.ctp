<div class="row">
	<div class="col-xs-12">
		<div class="box box-primary">
			...
			<div class="box-body ">
				<?= $this->Form->create($model, array('role' => 'form', 'type' => 'file', 'id' => 'halls-add-form')); ?>
					<fieldset>
                            ...
                            <div class="col-sm-6 col-xs-12">
								<div class="form-group">
									<?php echo $this->Form->input('cinema_id', array(
										...
										'required' => true,
										'id' => 'cinema_ids',
										'label' => '<font color="red">*</font>'.__d('place', 'cinema_title'),
										'options' => $cinema,
									)); ?>
								</div>
                            </div>
						...
						<div class="row">
                            <div class="col-sm-6 col-xs-12">
								<div class="form-group">
									<?= $this->Form->input('max_seat', array('class' => 'form-control', 'required' => true, 'label' => '<font color="red">*</font>'.__d('place', 'max_seat'))); ?>
								</div>
							</div>
                        </div>
						...
						<div class="row pull-to-bottom">
                            <div class="col-sm-2 col-xs-12">
								<div class="form-group">
									<?= $this->Form->input('row', array('class' => 'form-control', 'id' => 'row_number', 'required' => true, 'type' => 'number', 'label' => '<font color="red">*</font>'.__d('place', 'row'), 
										'type' => 'number',
										'min' => '1',
										'step' => '1',
							...
							<div class="col-sm-2 col-xs-12">
								<div class="form-group">
									<?= $this->Form->input('column', array('class' => 'form-control', 'id' => 'column_number', 'required' => true, 'type' => 'number', 'label' => '<font color="red">*</font>'.__d('place', 'column'), 
										'type' => 'number',
										'min' => '1',
										'step' => '1',
										'oninput' => "validity.valid||(value='');",)); ?>
