<div class="row">
	<div class="col-xs-12">
		<div class="box box-primary">
			...
			<div class="box-body ">
				<?= $this->Form->create($model, array('role' => 'form', 'type' => 'file', 'id' => 'staffs-add-form')); ?>
					<fieldset>
								...
								<div class="form-group">
									<?php
										echo $this->Form->input('country_code', array(
											'class' => 'form-control selectpicker',
											'label' => '<font style="color: red">*</font>' . __('country_code'),
						...
						<div class="row">
                            <div class="col-sm-6 col-xs-12">
								<div class="form-group">
									<?= $this->Form->input('username', array('class' => 'form-control', 'required' => true, 'label' => '<font color="red">*</font>'.__('username'))); ?>
								</div>
                            </div>
                        </div>
