...
<div class="row filter-panel">
	<div class="col-md-12">
		<?php 
			echo $this->Form->create('Cinema.hall_filter', array(
				'url' => array('controller' => 'halls', 'action' => 'index', 'admin' => true, 'prefix' => 'admin'),
                'class' => 'form_filter',
                'type' => 'get',
			));
		?>
                    ...
                    <div class="pull-right vtl-buttons">
                        ...
                        <?php
                            echo $this->Html->link(__('reset'), array(
                                'plugin' => 'cinema', 'controller' => 'halls', 'action' => 'index',
