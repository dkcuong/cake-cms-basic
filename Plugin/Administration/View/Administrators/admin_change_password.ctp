							...
							<div class="form-group has-feedback col-xs-12">
								<?php 
									echo $this->Form->input('password', array(
										'class' => 'form-control',
										'placeholder' => __d('administration', 'password'),
										'after' => '<span class="glyphicon glyphicon-lock form-control-feedback"></span>',
										'label' => __d('administration', 'password')
									));
								?>
							</div>
							<div class="form-group has-feedback col-xs-12">
								<?php 
									echo $this->Form->input('confirm_password', array(
                                        'type' => 'password',
										'class' => 'form-control',
										'placeholder' => __d('administration','confirm_password'),
										'after' => '<span class="glyphicon glyphicon-lock form-control-feedback"></span>',
										'label' => __d('administration', 'confirm_password')
									));
								?>
							</div>
