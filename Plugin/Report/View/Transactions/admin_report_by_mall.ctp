...
<?= $this->element('Report.spending_by_mall_filter', array(
...
<div class="row">
    ...
    <div class="box box-all-info">
        <div class="box-body">
            <h2 ><?php echo __('spending_by_mall'); ?></h2>
                ...
                <tbody>
                    <?php 
                        ...
                        <tr>
                            ...
                            <th class="text-center"><?= isset($malls[$item['Order']['mall_id']]) ? $malls[$item['Order']['mall_id']] : '' ?></th>
