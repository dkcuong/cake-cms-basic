	...
	<div class="col-xs-12">
		<div class="box box-primary">
			<div class="box-header">
				<h3 class="box-title"><?php echo __d('ticket_type','import_item'); ?></h3>
			</div>

			<div class="box-body">
				<?php echo $this->Form->create('TicketType', array('role' => 'form','type' => 'file')); ?>
					<fieldset>

						<div class="form-group">
							<input type="file" name="data[TicketType][file]" accept=".xls">
						</div>
