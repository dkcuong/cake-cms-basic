 ...
 */
class MobileMenusController extends ContentAppController {
    public $components = array('Paginator');
    private $model = 'MobileMenu';
    ...
    private $poster_prefix = 'mobile-menu';

    public function beforeFilter(){
        parent::beforeFilter();
        $this->set('title_for_layout', __d('mobile_menu', 'item_title'));
    }
    ...
    public function admin_export(){
        ...
        if( $this->request->is('get') ) {
            ...
            if ($result) {
                ...
                try{
                    $file_name = 'mobile_menu_'.date('Ymd');
