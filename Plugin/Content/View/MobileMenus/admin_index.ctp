...
<?= $this->element('Content.promotion_ad_filter', array(
            ...
            <div class="box-header">
                <div class="box-tools pull-right">
                    <?php if(isset($permissions[$model]['add']) && ($permissions[$model]['add'] == true)){ ?>
                        <?= $this->Html->link( '<i class="glyphicon glyphicon-plus"></i> ' . __d('mobile_menu', 'add_item'), array('action' => 'add'), array('class' => 'btn btn-primary', 'escape' => false)); ?>
                    <?php } ?>
                </div>
            </div>
            ...
            <div class="box-body table-responsive">
                <table id="TicketTypes" class="table table-bordered table-striped">
                    ...
                    <tr>
                        ...
                        <th class="text-center"><?= $this->Paginator->sort('link', __d('mobile_menu', 'link')); ?></th>
