...
<div class="row filter-panel">
    <div class="col-md-12">
        <?php 
            echo $this->Form->create('Content.mobile_menu_filter', array(
                'url' => array('controller' => 'mobile_menus', 'action' => 'index', 'admin' => true, 'prefix' => 'admin'),
                'class' => 'form_filter',
                'type' => 'get',
            ));
        ?>
                    ...
                    <div class="pull-right vtl-buttons">
                        ...
                        <?php
                            echo $this->Html->link(__('reset'), array(
                                'plugin' => 'content', 'controller' => 'mobile_menus', 'action' => 'index',
