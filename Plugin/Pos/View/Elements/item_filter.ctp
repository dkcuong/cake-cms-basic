...
<div class="row filter-panel">
	<div class="col-md-12">
		<?php 
			echo $this->Form->create('Pos.item_filter', array(
				'url' => array('controller' => 'items', 'action' => 'index', 'admin' => true, 'prefix' => 'admin'),
                'class' => 'form_filter',
                'type' => 'get',
			));
		?>
                ...
                <div class="col-md-4">
                    <?php 
                        echo $this->Form->input('item_group', array(
                            ...
                            'options' => $item_groups,
                            'selected' =>  isset($data_search['item_group']) ? $data_search['item_group'] : '',
                    ...
                    <div class="pull-right vtl-buttons">
                        ...
                        <?php
                            echo $this->Html->link(__('reset'), array(
                                'plugin' => 'pos', 'controller' => 'items', 'action' => 'index',
