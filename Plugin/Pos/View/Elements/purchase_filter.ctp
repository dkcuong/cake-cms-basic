...
<div class="row filter-panel">
	<div class="col-md-12">
		<?php 
			echo $this->Form->create('Pos.purchase_filter', array(
				'url' => array('controller' => 'purchases', 'action' => 'index', 'admin' => true, 'prefix' => 'admin'),
                'class' => 'form_filter',
                'type' => 'get',
			));
		?>
                    ...
                    <div class="pull-right vtl-buttons">
                        ...
                        <?php
                            echo $this->Html->link(__('reset'), array(
                                'plugin' => 'pos', 'controller' => 'purchases', 'action' => 'index',
