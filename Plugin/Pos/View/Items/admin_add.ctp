	...
	<div class="col-xs-12">
		<div class="box box-primary">
			<div class="box-header">
				<h3 class="box-title"><?= __d('item', 'add_item'); ?></h3>
			</div>
			...
			<div class="box-body ">
				<?= $this->Form->create($model, array('role' => 'form', 'type' => 'file', 'id' => 'ticket_type-add-form')); ?>
					<fieldset>
						...
						<div class="form-group">
							<?= $this->Form->input('material', array('class' => 'form-control', 'label' => __d('item', 'material'))); ?>
						</div>
								...
								<div class="form-group">
			                        <?php
			                            echo $this->element('images_upload_customize', array(
			                                ...
			                                'required' => true,
			                                'img_review_url' => isset($this->request->data['Item']['image']) ? $this->request->data['Movie']['poster'] : ''
			                            ));
			                        ?>
								</div>
                            </div>
