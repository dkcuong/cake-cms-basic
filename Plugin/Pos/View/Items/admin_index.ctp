...
<?= $this->element('Pos.item_filter', array(
		...
		<div class="box box-primary">
			<div class="box-header">
                ...
                <?php if(isset($permissions[$model]['add']) && ($permissions[$model]['add'] == true)){ ?>
                    <?= $this->Html->link( '<i class="glyphicon glyphicon-plus"></i> ' . __d('item', 'add_item'), array('action' => 'add'), array('class' => 'btn btn-primary', 'escape' => false)); ?>
                <?php } ?>
				</div>
			</div>	
				...
				<table id="Items" class="table table-bordered table-striped">
					<thead>
						<tr>
							...
							<th class="text-center"><?= $this->Paginator->sort('price', __('price')); ?></th>
							<!--
							<th class="text-center"><?= $this->Paginator->sort('availability', __d('item', 'availability')); ?></th>
							-->
							<th class="text-center"><?= $this->Paginator->sort('item_group', __d('item_group', 'item_title')); ?></th>
							<th class="text-center"><?= $this->Paginator->sort('material', __('material')); ?></th>
					...
					<tbody>
                        <?php foreach ($dbdatas as $dbdata): ?>
							<tr>
								...
								<!--
								<td class="text-center">
									<?= $this->element('view_check_ico', array('_check' => $dbdata[$model]['availability'])); ?>
								</td>		            
								-->
								<td class="text-center">
