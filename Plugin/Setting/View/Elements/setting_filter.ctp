...
<div class="row filter-panel">
	<div class="col-md-12">
		<?php 
			echo $this->Form->create('Pos.ticket_type_filter', array(
				'url' => array('controller' => 'settings', 'action' => 'index', 'admin' => true, 'prefix' => 'admin'),
                'class' => 'form_filter',
                'type' => 'get',
			));
		?>
                    ...
                    <div class="form-group">
                        <?php
                            echo $this->Form->input('slug', array(
                                'class' => 'form-control',
                                'label' => __('slug'),
                                'value' => isset($data_search["slug"]) ? $data_search["slug"] : '',
                            ));
                        ?>
                    </div>
                </div>
                    ...
                    <div class="form-group">
                        <?php
                            echo $this->Form->input('value', array(
                                'class' => 'form-control',
                                'label' => __('value'),
                                'value' => isset($data_search["value"]) ? $data_search["value"] : '',
                            ));
                        ?>
                    </div>
                </div>
                    ...
                    <div class="pull-right vtl-buttons">
                        ...
                        <?php
                            echo $this->Html->link(__('reset'), array(
                                'plugin' => 'setting', 'controller' => 'settings', 'action' => 'index',
