...
<?= $this->element('Setting.setting_filter', array(
		...
		<div class="box box-primary">
			<div class="box-header">
                ...
                <?php if(isset($permissions[$model]['add']) && ($permissions[$model]['add'] == true)){ ?>
                    <?= $this->Html->link( '<i class="glyphicon glyphicon-plus"></i> ' . __d('setting', 'add_item'), array('action' => 'add'), array('class' => 'btn btn-primary', 'escape' => false)); ?>
                <?php } ?>
				</div>
			</div>	
				...
				<table id="Buses" class="table table-bordered table-striped">
					<thead>
						<tr>
							...
							<th class="text-center"><?= $this->Paginator->sort('value', __d('setting','value')); ?></th>
